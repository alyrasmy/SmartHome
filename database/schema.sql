...
CREATE TABLE user( user_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, user_name varchar(255), user_username varchar(255), email varchar(255), password varchar(255), isadmin boolean, main_room INT, FOREIGN KEY (main_room) REFERENCES room(room_id)) ENGINE=InnoDB DEFAULT CHARSET=latin1;
